...
\begin{proof}
Define the price mapping $T: P \mapsto P'$ by $P'_i = (1+\tau_i) \theta_i(\mu)^{-1} K_i(S_i, A_i(S_i), P)$. Labor essentiality implies that the cost share of intermediates is strictly below one: for some $\kappa < 1$, the mapping $T$ is a contraction. By Banach's fixed point theorem, $T$ has a unique fixed point.
\end{proof}
